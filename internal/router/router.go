...
import (
	...
	"materialcore/admin"
	adminmw "materialcore/admin/middleware"
	"materialcore/internal/config"
	jwtmgr "materialcore/internal/pkg/jwt"
...
func Setup(db *gorm.DB, cfg *config.Config) *gin.Engine {
	...
	r.GET("/health", func(c *gin.Context) {
		c.JSON(200, gin.H{"status": "ok", "service": "materialcore"})
	})
	...
	admin.RegisterRoutes(adminGroup, h, exportH)
